...
export class TypeormInstrumentation extends InstrumentationBase<any> {
    ...
    protected init() : InstrumentationModuleDefinition<any>[] {
        const selectQueryBuilder = new InstrumentationNodeModuleDefinition<any>(
            'typeorm',
            ['>0.2.28'],
        ...
        const connection = new InstrumentationNodeModuleDefinition<any>(
            'typeorm',
            ['>0.2.28 <0.3.0'],
            (moduleExports, moduleVersion) => {
        ...
        const dataSource = new InstrumentationNodeModuleDefinition<any>(
            'typeorm',
            ['>=0.3.0'],
            (moduleExports, moduleVersion) => {
        ...
        const entityManager = new InstrumentationNodeModuleDefinition<any>(
            'typeorm',
            ['>0.2.28'],
            (moduleExports, moduleVersion) => {
